...
class PostService {
    findAllExc = async ({ findParams, sortParams, page, limit, skip, currentUser, }) => {
        try {
            ...
            logger_1.default.error("PostService: findAllExc", "errorInfo:" + JSON.stringify(error));
    ...
    findByIdExc = async (id) => {
        try {
            ...
            logger_1.default.error("PostService: findByIdExc", "errorInfo:" + JSON.stringify(error));
            return Promise.reject(error);
        }
    };
}

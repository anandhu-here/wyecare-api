...
class PasswordController {
    ...
    sendResetPasswordOtp = async (req, res, next) => {
        ...
        try {
            ...
            logger_1.default.error("PasswordController: sendResetPasswordOtp", "errorInfo:" + JSON.stringify(error));
    ...
    resetPassword = async (req, res, next) => {
        ...
        try {
            ...
            const errorMessage = error?.message || error || strings_1.default.SOMETHING_WENT_WRONG;
            logger_1.default.error("PasswordController: resetPassword", "errorInfo:" + JSON.stringify(error));
            res.status(statusCodes_1.default.BAD_REQUEST);
            return res.json({
                success: false,
                error: errorMessage,
    ...
    changePassword = async (req, res, next) => {
        ...
        try {
            ...
            const errorMessage = error?.message || error || strings_1.default.SOMETHING_WENT_WRONG;
            logger_1.default.error("PasswordController: changePassword", "errorInfo:" + JSON.stringify(error));
            res.status(statusCodes_1.default.BAD_REQUEST);
            return res.json({
                success: false,
                error: errorMessage,

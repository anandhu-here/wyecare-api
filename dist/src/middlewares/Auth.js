...
const register_1 = require("src/validators/register");
...
class AuthMiddleware {
    ...
    static async validateRegistration(req, res, next) {
        try {
            const { error } = register_1.registerValidator.validate(req.body);
            logger_1.default.info("validateRegistration", error);
            if (error) {
